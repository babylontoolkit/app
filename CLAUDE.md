...
- **Stage 4 — full product surface:** ⬅️ **NEXT.** share/gallery/remix (§4.8), assets tab (§4.9), GitHub Sync (§4.13), MCP (§4.14), Game Backends (§4.15), admin (§4.10)
