...
- These files ship in the played game, so mind their weight. Photographic art (hero backgrounds, textures, panels, scenery) defaults to jpg — leave \`output_format\` unset for it. Pass \`output_format: "png"\` ONLY for art that genuinely needs transparency (logos, emblems, sprites, cut-out characters). A 2K photographic png is ~10MB against under 1MB as jpg — big PNGs are what bloat the project.
