...
- These files ship in the played game, so mind their weight: pass \`output_format: "jpg"\` for anything photographic (hero backgrounds, textures, panels, scenery), and reserve \`png\` for art that genuinely needs transparency (logos, emblems, sprites, cut-out characters). A 2K photographic png is ~10MB against under 1MB as jpg, for the same price and no visible difference.
